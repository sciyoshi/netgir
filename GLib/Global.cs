...
namespace GLib {
	...
	public class Global
	{
		...
		public static string ProgramName {
			get {
				return Marshaller.PtrToStringGFree(g_get_prgname());
			}
			set { 
				IntPtr native_name = Marshaller.StringToPtrGStrdup (value);
		...
		public static string ApplicationName {
			get {
				return Marshaller.PtrToStringGFree(g_get_application_name());	
			}
			set {
				IntPtr native_name = Marshaller.StringToPtrGStrdup (value);
