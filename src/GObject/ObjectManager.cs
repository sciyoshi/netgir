// GObject.ObjectManager.cs - GObject ObjectManager class implementation
//
...
namespace GObject {
	...
	public class ObjectManager {
		...
		public static GObject.Object CreateObject (IntPtr raw)
		{
			if (raw == IntPtr.Zero)
				return null;
			...
			GObject.Object obj;
			try {
				obj = Activator.CreateInstance (type, flags, null, new object[] {raw}, null) as GObject.Object;
			} catch (MissingMethodException) {
				throw new GObject.MissingIntPtrCtorException ("GObject.Object subclass " + type + " must provide a protected or public IntPtr ctor to support wrapping of native object handles.");
			}
			return obj;
		}
