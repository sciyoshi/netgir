// GObject.ToggleRef.cs - GObject ToggleRef class implementation
//
...
namespace GObject {
	...
	internal class ToggleRef {
		...
		public GObject.Object Target {
			get {
				if (reference == null)
					return null;
				else if (reference is GObject.Object)
					return reference as GObject.Object;

				WeakReference weak = reference as WeakReference;
				return weak.Target as GObject.Object;
			}
		}
		...
		{
			if (is_last_ref && reference is GObject.Object)
