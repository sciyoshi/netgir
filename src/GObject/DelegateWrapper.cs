	...
	public class DelegateWrapper
	{
		...
		protected DelegateWrapper (object o)
		{
			if (o != null) {
				...
				if (o is GObject.Object) {
					AddDestroyNotify ((GObject.Object) o);
				}
			} else {
		...
		private void AddDestroyNotify (GObject.Object o) {
		...
		// This callback is invoked by GObject to indicate that the
