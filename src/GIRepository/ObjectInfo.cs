...
namespace GIRepository
{
	public class ObjectInfo : RegisteredTypeInfo
	{
		...
		public string TypeName {
			get { return GObject.Marshaller.Utf8PtrToString(g_object_info_get_type_name(Handle)); }
		}

		public string TypeInit {
			get { return GObject.Marshaller.Utf8PtrToString(g_object_info_get_type_init(Handle)); }
		}
