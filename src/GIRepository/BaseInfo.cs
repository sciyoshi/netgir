...
{
	public class BaseInfo : GObject.Opaque
	{
		...
		protected override GObject.Opaque Copy(IntPtr raw)
		{
			g_base_info_ref(raw);
			return this;
		}
		...
		public string Name {
			get { return GObject.Marshaller.Utf8PtrToString(g_base_info_get_name(Handle)); }
		}
