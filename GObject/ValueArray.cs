...
namespace GObject {
	...
	public class ValueArray : IDisposable, ICollection, ICloneable, IWrapper {
		...
		[DllImport("libgobject-2.0-0.dll")]
		static extern void g_value_array_append (IntPtr raw, ref GObject.Value val);

		public void Append (GObject.Value val)
		{
			g_value_array_append (Handle, ref val);
		}

		[DllImport("libgobject-2.0-0.dll")]
		static extern void g_value_array_insert (IntPtr raw, uint idx, ref GObject.Value val);

		public void Insert (uint idx, GObject.Value val)
		{
			g_value_array_insert (Handle, idx, ref val);
		}

		[DllImport("libgobject-2.0-0.dll")]
		static extern void g_value_array_prepend (IntPtr raw, ref GObject.Value val);

		public void Prepend (GObject.Value val)
		{
