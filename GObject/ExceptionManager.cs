// GObject.Application.cs - static Application class
//
	...
	public class ExceptionManager {
		...
		public static void RaiseUnhandledException (Exception e, bool is_terminal)
		{
			if (UnhandledException == null) {
				...
				Console.Error.WriteLine ("  Note: Applications can use GObject.ExceptionManager.UnhandledException to handle the exception.");
