...
namespace GObject {
	...
	public class Object : IWrapper, IDisposable {
		...
		public static Object GetObject(IntPtr o, bool owned_ref)
		{
			...
			obj = GObject.ObjectManager.CreateObject(o); 
			if (obj == null) {
				g_object_unref (o);
				return null;
			}
		...
		[NetGir.CDeclCallback]
		delegate void GetPropertyDelegate (IntPtr GObject, uint property_id, ref GObject.Value value, IntPtr pspec);

		static void GetPropertyCallback (IntPtr handle, uint property_id, ref GObject.Value value, IntPtr param_spec)
		{
			GObject.Object obj = GObject.Object.GetObject (handle, false);
		...
		[NetGir.CDeclCallback]
		delegate void SetPropertyDelegate (IntPtr GObject, uint property_id, ref GObject.Value value, IntPtr pspec);

		static void SetPropertyCallback(IntPtr handle, uint property_id, ref GObject.Value value, IntPtr param_spec)
		{
			GObject.Object obj = GObject.Object.GetObject (handle, false);
		...
		protected Object ()
		{
			CreateNativeObject (new string [0], new GObject.Value [0]);
		}
		...
		public static GObject.GType GType {
			get {
				return GType.Object;
			}
		}
		...
		internal GObject.GType NativeType {
			get {
				return LookupGType ();
			}
		}
		...
		[Obsolete ("Replaced by GObject.Signal marshaling mechanism.")]
		...
		{
			try {
				GObject.Signal sig = ((GCHandle) gch).Target as GObject.Signal;
				if (sig == null)
				...
				handler (GObject.Object.GetObject (handle), args);
			} catch (Exception e) {
		...
		[DllImport("libgobject-2.0-0.dll")]
		static extern void g_object_get_property (IntPtr obj, IntPtr name, ref GObject.Value val);

		protected GObject.Value GetProperty (string name)
		{
		...
		[DllImport("libgobject-2.0-0.dll")]
		static extern void g_object_set_property (IntPtr obj, IntPtr name, ref GObject.Value val);

		protected void SetProperty (string name, GObject.Value val)
		{
			IntPtr native_name = GObject.Marshaller.StringToPtrGStrdup (name);
		...
		{
			IntPtr native_name = GObject.Marshaller.StringToPtrGStrdup (property_name);
		...
		[DllImport("libgobject-2.0-0.dll")]
		protected static extern void g_signal_chain_from_overridden (IntPtr args, ref GObject.Value retval);

		[DllImport("libgobject-2.0-0.dll")]
		static extern bool g_type_check_instance_is_a (IntPtr obj, IntPtr gtype);

		public static bool IsObject (IntPtr obj)
		{
		...
		protected int RefCount {
			get {
				GObjectStruct native = (GObjectStruct) Marshal.PtrToStructure (Handle, typeof (GObjectStruct));
